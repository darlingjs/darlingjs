...
var Pipeline = function(pipeline, system) {
  ...
  function buildHandlerForEachEntity(lazy, handler) {
    if (lazy) {
      return buildLazyHandler(handler);
    } else {
      return buildActiveHandler(handler);
    }
  }
   ...
   * @returns {Function}
   */
  function buildLazyHandler(handler) {
   ...
   * @returns {Function}
   */
  function buildActiveHandler(handler) {
    return function(interval) {
  ...
  if (system) {
    ...
    if (system.beforeUpdate) {
      ...
      this.beforeUpdateList.add(buildHandlerForEachEntity(this.lazy, beforeUpdateEntity));
    } else {
    ...
    if (system.updateOne) {
      ...
      this.updateOneList.add(buildHandlerForEachEntity(this.lazy, updateOneEntity));
    } else {
    ...
    if (system.afterUpdate) {
      ...
      this.afterUpdateList.add(buildHandlerForEachEntity(this.lazy, updateAfterEntity));
    } else {
