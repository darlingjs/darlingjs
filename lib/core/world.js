...
World.prototype.$has = function (name) {
  return isDefined(this.components[name]) || isDefined(this.$$injectedSystems[name]);
};
...
/**
 * Remove Entity or System from the World
...
World.prototype.$$addSystem = function (instance) {
  ...
  if (isDefined(instance.$require)) {
    instance.$$setNodes(this.filterByComponents(instance.$require));
  }
 ...
 * @param entity
 */
World.prototype.$$onComponentAdd = function (entity) {
