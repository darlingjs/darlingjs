    ...
    m.$s('ngCyclic2DLayer', {
        ...
        $addEntity: ['$entity', function($entity) {
            if ($entity.ngCyclic.patternWidth) {
                ...
                $entity.$add('ngMarkIfInsideOfTheViewPortHorizontal2D', insideConfigHorizontal3D);
                outsideConfigHorizontal2D.minWidth = $entity.ngCyclic.patternWidth;
                $entity.$add('ngMarkIfOutsideOfTheViewPortHorizontal2D', outsideConfigHorizontal2D);
            }
            if ($entity.ngCyclic.patternHeight) {
                insideConfigVertical.minHeight = $entity.ngCyclic.patternHeight;
                $entity.$add('ngMarkIfInsideOfTheViewPortVertical2D', insideConfigVertical);
                outsideConfigVertical2D.minHeight = $entity.ngCyclic.patternHeight;
                $entity.$add('ngMarkIfOutsideOfTheViewPortVertical2D', outsideConfigVertical2D);
            }
        }]
    });
    ...
    var outsideConfigHorizontal2D = {
        handler: function($entity, lowerEdge, higherEdge) {
            ...
            if (!$entity.ngMarkIfInsideOfTheViewPortHorizontal2D) {
                $entity.$add('ngMarkIfInsideOfTheViewPortHorizontal2D', insideConfigHorizontal2D);
            }
    ...
    var outsideConfigVertical2D = {
        handler: function($entity, lowerEdge, higherEdge) {
            ...
            if (!$entity.ngMarkIfInsideOfTheViewPortVertical2D) {
                $entity.$add('ngMarkIfInsideOfTheViewPortVertical2D', insideConfigVertical2D);
            }
    ...
    m.$s('ngCyclic3DLayer', {
        ...
        $addEntity: ['$entity', function($entity) {
            if ($entity.ngCyclic.patternWidth > 0) {
                ...
                $entity.$add('ngMarkIfInsideOfTheViewPortHorizontal3D', insideConfigHorizontal3D);
                outsideConfigHorizontal3D.minWidth = $entity.ngCyclic.patternWidth;
                $entity.$add('ngMarkIfOutsideOfTheViewPortHorizontal3D', outsideConfigHorizontal3D);
            }
            if ($entity.ngCyclic.patternHeight > 0) {
                insideConfigVertical3D.minHeight = $entity.ngCyclic.patternHeight;
                $entity.$add('ngMarkIfInsideOfTheViewPortVertical3D', insideConfigVertical3D);
                outsideConfigVertical3D.minHeight = $entity.ngCyclic.patternHeight;
                $entity.$add('ngMarkIfOutsideOfTheViewPortVertical3D', outsideConfigVertical3D);
            }
        }]
    });
